...
svg = f'''<svg xmlns="http://www.w3.org/2000/svg" width="{W}" height="{H}" viewBox="0 0 {W} {H}">
  ...
  <!-- maru mark: ring + two nested triangles + centre ring -->
  <g transform="translate(550,175)" fill="none" stroke="#ecece8" stroke-linejoin="round">
    <circle cx="50" cy="50" r="34" stroke-width="6"/>
    <polygon points="50,18.5 22.72,65.75 77.28,65.75" stroke-width="3"/>
    <polygon points="50,35 37.01,57.5 62.99,57.5" stroke-width="2"/>
    <polygon points="50,42.5 43.5,53.75 56.5,53.75" stroke-width="1.5"/>
  </g>
  <!-- wordmark -->
