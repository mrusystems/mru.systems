...
[Apache License 2.0](./LICENSE). That license grants generous rights to use,
modify, and redistribute the **code** — but, per Apache 2.0 §6, it does **not**
grant any rights to our trademarks, trade names, logos, or brand identity. This
notice governs those marks separately.

## Use that's fine (no permission needed)

You're welcome to make honest, descriptive ("nominative") reference to Mru, for
example to:
...
endorse, or are affiliated with your work unless we actually are.
...
- Redistribute the code (in source or modified form) under the Mru name or mark
  in a way that suggests it's the official Mru.
- Use the marks in a way that's likely to confuse people about the origin of a
  product or service, or that suggests endorsement or affiliation we haven't
  agreed to.

If the code license (Apache 2.0) and this trademark notice ever appear to
conflict, the license still governs the **code**, and this notice still governs
the **marks** — they cover different things.
